...
function ready(){
    ...
    //Agerego funcionalidad a los botones Agregar al Carrito 
    ...
    //Agregar funcinalidad al boton pagar
...
//Actualiza el total del carrrito
function actualizarTotalCarrito(){
    ...
    for(var i=0; i < carritoItems.length;i++){
        ...
        //quitamos el simbolo peso y el punto milesimo 
...
function agregarAlCarritoClicked(event){
    ...
    var imagenSrc = item.getElementsByClassName('Imagenes-item')[0].src;
    console.log(imagenSrc);

    //La siguiente funcion agrega el elemento al carrito. Le mando por paràmetros los valores 
...
function agregarItemAlCarrito(titulo, precio, imagenSrc){
    ...
    //Vamos a controlar que el item que esta ingresando no se encuentra ya en el ya carrito.
    ...
    <div class="carrito-item">
        <img src="${imagenSrc}" alt="" width="45px">
